...
def test_build_vrf_case_creates_shenyang_case_file(tmp_path: Path) -> None:
    case_path = build_vrf_case("shenyang", output_root=tmp_path)

    assert case_path.name == "shenyang__vrf.idf"
    ...
    assert vrf_condensers[0].fields[19] == "-25"
