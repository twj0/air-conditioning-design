...
def test_build_ideal_loads_summary_returns_chongqing_case_metadata(tmp_path) -> None:
    ...
    summary = build_ideal_loads_summary("chongqing", tmp_path, floor_area_m2=100.0)

    assert summary["case_id"] == "chongqing__ideal_loads"
