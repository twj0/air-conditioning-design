...
def test_build_ideal_loads_summary_returns_shenyang_case_metadata(tmp_path) -> None:
    ...
    summary = build_ideal_loads_summary("shenyang", tmp_path, floor_area_m2=100.0)

    assert summary["case_id"] == "shenyang__ideal_loads"
