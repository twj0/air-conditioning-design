...
def test_build_fcu_doas_case_creates_chengdu_case_file(tmp_path: Path) -> None:
    case_path = build_fcu_doas_case("chengdu", output_root=tmp_path)

    assert case_path.name == "chengdu__fcu_doas.idf"
