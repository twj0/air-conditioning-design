...
def test_build_ideal_loads_case_creates_shenyang_case_file(tmp_path: Path) -> None:
    case_path = build_ideal_loads_case("shenyang", output_root=tmp_path)

    assert case_path.name == "shenyang__ideal_loads.idf"
