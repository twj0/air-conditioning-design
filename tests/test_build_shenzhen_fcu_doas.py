...
def test_build_fcu_doas_case_creates_shenzhen_case_file(tmp_path: Path) -> None:
    case_path = build_fcu_doas_case("shenzhen", output_root=tmp_path)

    assert case_path.name == "shenzhen__fcu_doas.idf"
