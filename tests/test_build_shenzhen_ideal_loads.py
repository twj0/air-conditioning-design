...
def test_build_ideal_loads_case_creates_shenzhen_case_file(tmp_path: Path) -> None:
    case_path = build_ideal_loads_case("shenzhen", output_root=tmp_path)

    assert case_path.name == "shenzhen__ideal_loads.idf"
