...
def test_build_vrf_case_creates_chongqing_case_file(tmp_path: Path) -> None:
    case_path = build_vrf_case("chongqing", output_root=tmp_path)

    assert case_path.name == "chongqing__vrf.idf"
