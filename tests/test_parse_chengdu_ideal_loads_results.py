...
def test_build_ideal_loads_summary_returns_chengdu_case_metadata(tmp_path) -> None:
    ...
    summary = build_ideal_loads_summary("chengdu", tmp_path, floor_area_m2=100.0)

    assert summary["case_id"] == "chengdu__ideal_loads"
