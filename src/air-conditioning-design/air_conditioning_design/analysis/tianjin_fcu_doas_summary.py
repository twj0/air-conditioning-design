...
def build_tianjin_fcu_doas_summary(
    ...
    *,
    ...
    terminal_count = _count_objects(idf_path, "ZoneHVAC:FourPipeFanCoil")
    plant_loop_count = _count_objects(idf_path, "PlantLoop")
...
def write_tianjin_fcu_doas_summary(
    ...
    ensure_directories()
    summary = build_tianjin_fcu_doas_summary(results_dir)
