...
为保证多城市比较的公平性，本文以同一中型办公建筑参考原型为基础构建共享母版建筑，并在此基础上派生出五个城市分支\cite{deru2011reference,field2010reference}。当前模型中，空调服务建筑面积取\SI{4982}{\meter^2}，总共形成15个工况，包括5个理想负荷基线工况、5个VRF+DOAS工况和5个FCU+DOAS工况。
